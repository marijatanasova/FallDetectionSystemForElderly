...
int main(void)
{
  ...
  // Configure PB6 (SCL) - alternate function open-drain
  GPIOB->CRL &= ~(GPIO_CRL_MODE6 | GPIO_CRL_CNF6);
  GPIOB->CRL |= (GPIO_CRL_MODE6_1 | GPIO_CRL_CNF6_1 | GPIO_CRL_CNF6_0);

  // Configure PB7 (SDA) - alternate function open-drain
  ...
  // Set peripheral clock frequency (8MHz)
  I2C1->CR2 = 8;

  // Set clock control register for 100kHz I2C
  I2C1->CCR = 40;
  ...
  uint8_t whoAmI = I2C_ReadRegister(0x68, 0x75);
  /* USER CODE END 2 */
  // Read WHO_AM_I register from MPU6050
